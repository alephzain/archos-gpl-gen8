...
$(STAGING_DIR)/lib/$(LIBGLIB2_BINARY): $(LIBGLIB2_DIR)/glib/.libs/$(LIBGLIB2_BINARY)
	...
	rm -f $(STAGING_DIR)/lib/libglib-2.0.la
	rm -f $(STAGING_DIR)/lib/libgmodule-2.0.la
	rm -f $(STAGING_DIR)/lib/libgobject-2.0.la
	rm -f $(STAGING_DIR)/lib/libgthread-2.0.la
...
libglib2_test:
	echo $(libglib2_iconv) host: $(HOSTCC) target: $(TARGETCC)
