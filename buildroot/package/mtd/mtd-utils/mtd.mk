...
MTD_BUILD_TARGETS += $(addprefix $(MTD_DIR)/ubi-utils/new-utils/, $(MTD_UBI_TARGETS_y))
...
$(MTD_UBI_TARGETS): $(TARGET_DIR)/usr/sbin/% : $(MTD_DIR)/ubi-utils/new-utils/%
	cp -f $< $@
	$(STRIPCMD) $@

mtd: zlib $(MTD_TARGETS) $(MTD_UBI_TARGETS)
